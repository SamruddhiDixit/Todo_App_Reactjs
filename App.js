  ...
  return (
    ...
    <div className='todo-wrapper'>
      ...
      <div className='btn-area'>
        <button 
        className={`secondaryBtn ${isCompleteScreen==false && 'active'}`}onClick={()=>setIsCompleteScreen(false)}>ToDo
        </button>
        <button 
        className={`secondaryBtn ${isCompleteScreen==true && 'active'}`}onClick={()=>setIsCompleteScreen(true)}>Completed
        </button>
      </div>
      ...
      <textarea placeholder='Updated Desccription' 
        ...
        <div>
            ...
            <AiOutlineEdit classname='check-icon' onClick={()=>handleEdit(index,item)}title='updated?'/>
        </div>
        </div> 
        )
      }})}
